...
PaymentMethodObject PaymentMethodObjectFromJson(String str) => PaymentMethodObject.fromJson(json.decode(str));

String PaymentMethodObjectToJson(PaymentMethodObject data) => json.encode(data.toJson());
...
class PaymentMethodObject {
    ...
    factory PaymentMethodObject.fromJson(Map<String, dynamic> json) => PaymentMethodObject(
        id: json["id"],
        /*object: json["object"],
